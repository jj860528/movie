<template>
    <div>
        <el-row :gutter="24">
            ...
            <el-col :xl="16" :md="16" :xs="24">
                <el-row type="flex" justify="space-around" style = "align-items: baseline; ">
                    <el-col :span="12"><div class = "future-title"><p>即將上映</p></div ></el-col>
                    <el-col :span="6"><div class = "allMovie"><p style = "color:#409EFF">全部》</p></div ></el-col>
                </el-row>
                <el-row>
                    <el-col :xl="5" :md="5" :xs="9" v-for = "(movie , o) in futureMovie" :key="o" class = "movie" v-loading.fullscreen.lock="loading">
                        <el-card :body-style="{ padding: '0px' }" :id='movie.id' shadow="hover">
                            <img :src="'https://image.tmdb.org/t/p/w500/'+movie.poster_path" class="image">
                            <div style="padding: 14px;">
                                <el-tooltip  effect="dark" :content="movie.title" placement="top">
