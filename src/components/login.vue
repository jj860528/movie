                    ...
                    <transition name="el-zoom-in-center" mode="out-in">
                        <div v-show = "windowSwitch">
                            ...
                            <el-form  :model="loginform" style = "text-align: center; width:300px; margin:auto;">
                                ...
                                <el-form-item>
                                    <el-button type="primary" :loading="sta" @click="onLogin" style = "width:300px" @keyup.enter.native="onLogin">登入</el-button>
                                </el-form-item>
                            </el-form>
                    ...
                    <transition name="el-zoom-in-center" mode="out-in">
                        <div v-show = "windowSwitch === false">
                            ...
                            <el-form  :model="regestered" style = "text-align: center; width:300px; margin:auto;">
                                ...
                                <el-form-item>
                                    <el-button type="primary" :loading="false" @click="onRegistered" style = "width:300px" @keyup.enter.native="onRegistered">註冊</el-button>
                                </el-form-item>
                            </el-form>
                            <el-row type="flex" class="regsteredwindow2" justify="center">
                                <div class = "miniwindo2">
                                    <el-col :span="12"><div style = "text-align:right;">已經有帳號嗎?</div></el-col>
                                    <el-col :span="12"><a  href="#" class = "windo2Text" @click = "Switch">進行登入</a></el-col>
                                </div>
                            </el-row>  
                        </div>
                    </transition>
...
export default {
    ...
    created: function() { var _this = this; document.onkeydown = function(e) {
         let key = window.event.keyCode; if (key == 13) {
    ...
    methods: {
        ...
        onRegistered(){
            ...
            if(this.regestered.email == ""){
                ...
                axios("/chwz/register",self).then(function(data){
                    console.log(data)
                }).catch(function(error){
                    console.log(error)
                })
